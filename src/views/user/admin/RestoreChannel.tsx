...
import { restorehannel } from '../../../utils/admin';
...
export function RestoreChannel() {
    ...
    return (
      <div className={`flex flex-col h-full items-center justify-center`}>
        <p className={`text-lg mb-5`}>
          An app restart is required before this channel will appear again.
          <br /><br />
  ...
  return (
    <div className={`flex flex-col h-full items-center`}>
        <header className={`text-xl mb-5`}>Restore Channel</header>
